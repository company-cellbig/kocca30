...
2. **변환 스크립트 실행**
   ...
   ```json
   {
     ...
     "source": "03_References/_sources/<name>.<ext>",
     "converted": "03_References/converted/<name>.md",
     "figuresDir": "03_References/_figures/<name>",
     "sidecar": "03_References/_reviews/<name>.review.md",
...
3. **결과 파싱 및 후속 작업**
   ...
   - `05_Logs/log.md`에 `ingest` 작업유형으로 다음 형식의 항목 추가:
     ...
     - 원본: `03_References/_sources/<name>.<ext>`
     - 변환본: [[<name>]]
     - 검수 큐: [[<name>.review]]
     - 백엔드: <python|pandoc>
