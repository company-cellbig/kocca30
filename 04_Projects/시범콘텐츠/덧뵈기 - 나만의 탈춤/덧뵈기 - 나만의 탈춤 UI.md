...
| 나 | 가이드 화면 | Step 1 | 공용 (인트로, [[시범콘텐츠 공통 사양#5.2 인트로 (시작 + 동의)]]) | [[덧뵈기 - 나만의 탈춤 기획서#4.1 Step 1. 인트로 (시작 + 동의)]] |
| 다 | 이용 동의 화면 | Step 1 | 공용 (인트로, [[시범콘텐츠 공통 사양#5.2 인트로 (시작 + 동의)]]) | [[덧뵈기 - 나만의 탈춤 기획서#4.1 Step 1. 인트로 (시작 + 동의)]] |
