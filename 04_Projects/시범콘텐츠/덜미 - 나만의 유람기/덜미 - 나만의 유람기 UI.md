...
| 카 | 연락처 입력과 전송 화면 | Step 6 | 공용 (전송, §5.라) | [[덜미 - 나만의 유람기 기획서#바. Step 6. 결과물 전송]] |
...
덜미 고유 화면. 유저가 마당 유형 4종 중 하나를 고름. 시스템은 그 유형 풀에서 랜덤 마당 1개를 배정함 ([[덜미 - 나만의 유람기 기획서#다. Step 3. 마당 선택과 플롯 문답 (거리별 반복)]], §4.가 3) 마당 유형).
...
덜미 고유 화면. 완성된 그림동화 전자책을 페이지를 넘기며 감상함. 마지막 페이지에서 전송 버튼이 나옴 ([[덜미 - 나만의 유람기 기획서#마. Step 5. 결과물 표시]]).
...
공용 화면(전송, [[시범콘텐츠 공통 사양#5. 공통 화면]] 라). 연락처를 받아 그림동화 링크를 SMS로 보냄. 본 콘텐츠 개인정보는 휴대폰 번호 단일이며 얼굴 정보는 없음([[덜미 - 나만의 유람기 기획서#나. 개인정보 처리]]).
