...
def hwalgae(pen):        # 기막히다는 듯 양팔을 어깨높이로 활짝 벌린 채 버팀
    # 좌우 대칭에 손끝만 위로 꺾어 휘두르기, 소매 뿌리기와 실루엣을 가름
    head(pen, (128, 84))
    pen.line([(128, 110), (128, 180)])                  # 몸통
    pen.line([(128, 180), (100, 236)])                  # 다리
    pen.line([(128, 180), (156, 236)])
    pen.line([(128, 128), (62, 116), (44, 88)])         # 왼쪽으로 활짝 편 팔
    pen.line([(128, 128), (194, 116), (212, 88)])       # 오른쪽으로 활짝 편 팔
...
MOVES = [("활개펴기", hwalgae), ("찔러보기", jjilleo), ("휘둘러쫓기", hwidulleo),
