...
// 출력:
//   03_References/_sources/<name>.<ext>                       (원본 보존)
//   03_References/converted/<name>/<name>.md                  (변환 본문)
//   03_References/converted/<name>/figures/media/             (추출 이미지)
...
const refRoot = join(REPO_ROOT, '03_References');
...
if (ext === '.hwpx') {
  ...
  // MD: 03_References/converted/<name>.md, figures: 03_References/_figures/<name>/
