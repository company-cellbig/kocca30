...
const ALLOW_SECTION_MARK = new Set([
  ...
  '06_작업노트/위키정비/위키 정합성 검수 2026-07-02.md',            // 검수 시점 문서 상태 인용
  '06_작업노트/완료/시범콘텐츠 신규 3종 기획서 야간 작성 검토 패킷.md', // 검토 시점 문서 상태 인용
  '06_작업노트/완료/시범콘텐츠 신규 3종 UI 야간 작성 검토 패킷.md',    // 검토 시점 문서 상태 인용
]);
