...
> 셀빅 사내 킥오프 발표 문서. 무형문화유산 AI 과제가 무엇이고, 셀빅이 2년(1단계)에 걸쳐 무엇을 어떤 기술로 언제 만들지를 정리함.
...
> **발표 노트**: 서버의 1차연도 범위는 익명 결과물 다운로드까지임. 이어하기와 학습 기록 저장은 2차연도(디지털 도제)로 넘어가나, 2차 연속성을 지금부터 확장 설계할지가 논점임.
